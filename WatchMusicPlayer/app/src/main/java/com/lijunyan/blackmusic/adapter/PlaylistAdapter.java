...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final PlaylistAdapter.ViewHolder holder, final int position) {
        ...
        if (musicInfo.getId() == MyMusicUtil.getIntShared(Constant.KEY_ID)){
            ...
            holder.musicIndex.setTextColor(context.getResources().getColor(R.color.grey500));
            holder.musicSinger.setTextColor(context.getResources().getColor(R.color.grey500));
        }else {
            holder.musicName.setTextColor(context.getResources().getColor(R.color.colorWhite));
            holder.musicIndex.setTextColor(context.getResources().getColor(R.color.grey500));
            holder.musicSinger.setTextColor(context.getResources().getColor(R.color.grey500));
