...
//        Log.d(TAG, "onBindViewHolder: position = "+position);
        ...
        int appbg = CustomAttrValueUtil.getAttrColorValue(R.attr.colorAccent,R.color.grey200,context);
        int defaultTvColor = CustomAttrValueUtil.getAttrColorValue(R.attr.text_color,R.color.colorWhite,context);

        if (musicInfo.getId() == MyMusicUtil.getIntShared(Constant.KEY_ID)){
            holder.musicName.setTextColor(context.getResources().getColor(R.color.zhihuBlue));
            holder.musicIndex.setTextColor(context.getResources().getColor(R.color.zhihuBlue));
            holder.musicSinger.setTextColor(context.getResources().getColor(R.color.zhihuBlue));
        }else {
            holder.musicName.setTextColor(context.getResources().getColor(R.color.colorWhite));
            holder.musicIndex.setTextColor(context.getResources().getColor(R.color.grey200));
            holder.musicSinger.setTextColor(context.getResources().getColor(R.color.grey200));
        }
