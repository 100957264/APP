...
import com.android.fisewatchlauncher.constant.EaseMobConstant;
...
public class EaseCallActivity extends BaseActivity {
    public final static String TAG = "EaseCallActivity";
    ...
    protected Handler handler = new Handler(callHandlerThread.getLooper()) {
        ...
        public void handleMessage(Message msg) {
            EMLog.d("EMCallManager EaseCallActivity", "handleMessage ---enter block--- msg.what:" + msg.what);
            switch (msg.what) {
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        public void run() {                            
                            ...
                            Toast.makeText(EaseCallActivity.this, st2, Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
...
//                        if (NetUtils.hasDataConnection(EaseCallActivity.this)) {
//                            EMClient.getInstance().callManager().answerCall();
//                            isAnswered = true;
//                        } else {
//                            runOnUiThread(new Runnable() {
...
//                        }
            ...
            EMLog.d("EMCallManager EaseCallActivity", "handleMessage ---exit block--- msg.what:" + msg.what);
        }
    };
    ...
    protected void saveCallRecord() {
        ...
        if(callType == 0)
            message.setAttribute(EaseMobConstant.MESSAGE_ATTR_IS_VOICE_CALL, true);
        else
            message.setAttribute(EaseMobConstant.MESSAGE_ATTR_IS_VIDEO_CALL, true);
