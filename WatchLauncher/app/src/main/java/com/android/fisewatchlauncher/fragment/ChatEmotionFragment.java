...
import com.android.fisewatchlauncher.utils.EmotionUtils;
import com.android.fisewatchlauncher.utils.GlobalOnItemClickManagerUtils;
...
public class ChatEmotionFragment extends BaseFragment {
    ...
    com.android.fisewatchlauncher.widget.IndicatorView fragmentChatGroup;
    private View rootView;
    private
    com.android.fisewatchlauncher.adapter.EmotionPagerAdapter emotionPagerAdapter;
    ...
    private void initEmotion() {
        ...
        // item的间距
        int spacing = DpUtil.dp2px(getActivity(), 12);
        // 动态计算item的宽度和高度
        ...
        emotionPagerAdapter = new com.android.fisewatchlauncher.adapter.EmotionPagerAdapter(emotionViews);
    ...
    private GridView createEmotionGridView(List<String> emotionNames, int gvWidth, int padding, int itemWidth, int gvHeight) {
        ...
        // 给GridView设置表情图片
        com.android.fisewatchlauncher.adapter.EmotionGridViewAdapter adapter = new com.android.fisewatchlauncher.adapter.EmotionGridViewAdapter(getActivity(), emotionNames, itemWidth);
