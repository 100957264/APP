...
public class CoordinateUtils {
    ...
    public static GPSPoint gcj02_To_Bd09(double gg_lat, double gg_lon) {
        ...
        return new GPSPoint(bd_lat, bd_lon);
    }
    ...
    public static GPSPoint bd09_To_Gcj02(double bd_lat, double bd_lon) {
        ...
        return new GPSPoint(gg_lat, gg_lon);
    }

    /**
     * 地球坐标系 (WGS84) 与火星坐标系 (GCJ-02) 的转换算法 将 WGS84 坐标转换成 GCJ-02 坐标
     */
    public static GPSPoint gps84_To_Gcj02(double lat, double lon) {
    ...
    //=====================地球坐标系 (WGS84) 与火星坐标系 (GCJ-02) 的转换算法 ===========
    /**
     * 将 GCJ-02 坐标转换成 WGS84 坐标
     */
    public static GPSPoint gcj_To_Gps84(double lat, double lon) {
    ...
    private static GPSPoint transform(double lat, double lon) {
        if (outOfChina(lat, lon)) return new GPSPoint(lat, lon);
        double dLat = transformLat(lon - 105.0, lat - 35.0);
        double dLon = transformLon(lon - 105.0, lat - 35.0);
        double radLat = lat / 180.0 * pi;
        double magic = Math.sin(radLat);
