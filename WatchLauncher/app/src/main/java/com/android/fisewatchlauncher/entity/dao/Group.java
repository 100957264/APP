...
/**
 * @author mare
 * @Description:TODO 单个群组
 * @csdnblog http://blog.csdn.net/mare_blue
 * @date 2017/10/16
 * @time 10:09
 */
@Entity(nameInDb = "WetGroup")
public class Group {
    @Id
    ...
    @ToMany(joinProperties = {
            @JoinProperty(name = "groupId", referencedName = "memberId")
    })
    ...
    @Generated(hash = 628479326)
    public Group(String groupId, String displayName, String role, String bulletin,
            String timestamp) {
    ...
    public List<GroupMember> getGroupMembers() {
        if (groupMembers == null) {
            ...
            List<GroupMember> groupMembersNew = targetDao
                    ._queryGroup_GroupMembers(groupId);
            synchronized (this) {
                if (groupMembers == null) {
                    groupMembers = groupMembersNew;
                }
            }
        }
        return groupMembers;
